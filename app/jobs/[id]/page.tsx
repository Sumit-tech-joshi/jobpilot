...
export default async function JobDetailPage({ params }: PageProps) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-8">
      {/* Breadcrumb */}
      <div className="flex items-center gap-2 text-sm text-[#475569] mb-6">
        <Link href="/jobs" className="hover:text-[#8B5CF6] transition-colors">
          Find Jobs
        </Link>
        <span>/</span>
        <span className="text-[#94A3B8] truncate max-w-xs">{job.title}</span>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 min-w-0">
          <div className="bg-white/[0.02] border border-white/[0.06] rounded-2xl p-6 mb-5">
            ...
            {/* Meta */}
            <div className="flex flex-wrap gap-x-5 gap-y-2 text-sm text-[#94A3B8] mb-5">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-sm text-[#8B5CF6] hover:text-[#A78BFA] transition-colors"
            >
          ...
          <div className="bg-white/[0.02] border border-white/[0.06] rounded-2xl p-6">
            ...
            <div className="prose prose-invert max-w-none text-[#CBD5E1] text-sm leading-relaxed space-y-3">
